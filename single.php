			...
			<div class="post-container">
				...
				<?php if ( $post_format == 'gallery' ) : ?>
					...
					<div class="featured-media">	
						...
						<?php urstein_flexslider('post-image'); ?>
				...
				<div class="post-inner">
				    ...
				    <?php 
				    	$args = array(
							'before'           => '<div class="page-links"><span class="title">' . __( 'Pages:','urstein' ) . '</span>',
					...
					<div class="post-meta">
						...
						<?php if (has_category()) : ?>
							<p class="categories">
								<?php _e('In','urstein'); ?> <?php the_category(', '); ?>
							</p>
						<?php endif; ?>
						<?php if (has_tag()) : ?>
							<p class="tags">
					...
					<div class="post-navigation">
						...
						if (!empty( $prev_post )): ?>
							...
							<a class="post-nav-prev" title="<?php echo esc_attr( get_the_title($prev_post) ); ?>" href="<?php echo get_permalink( $prev_post->ID ); ?>">					
								<p><?php _e('Next','urstein'); ?><span class="hide"> <?php _e('Post','urstein'); ?></span></p>
						...
						if (!empty( $next_post )): ?>
							...
							<a class="post-nav-next" title="<?php echo esc_attr( get_the_title($next_post) ); ?>" href="<?php echo get_permalink( $next_post->ID ); ?>">
								...
								<p><?php _e('Previous','urstein'); ?><span class="hide"> <?php _e('Post','urstein'); ?></span></p>
							</a>
						<?php endif; ?>
